...
class BookCollection {
    ...
    public:
        ...
        void _destructorHelper(Book* T);
        void _showCollectionHelper(Book* T);
        void _showBooksByAuthorHelper(Book* T, string author);
        double _findHighestRatingHelper(Book* T, double currentHighest);
        void _printHighestRating(Book* T, double highestRating);
        int _getHeightHelper(Book* T, int counter);
};
