...
## Overview
Welcome to CSCI 2270 recitation 5! This recitation is to get you acquainted with . 
...
```console
jovyan@jupyter-yourcuid:~$ git clone git@github.com:cu-csci-2270-spring-2023/recitation-5-MyGitUsername.git
```
...
Please refer `Recitation 5.pdf` for more details.
...
2. Go to Canvas, locate the link titled **“Recitation 5”** and upload the zipped repository with your changes. Make sure you do submit your recitation prior to the deadline specified on Canvas.
