# CSCI 2270 – Data Structures - Recitation 7
## Overview
Welcome to CSCI 2270 recitation! This recitation is to get you acquainted with binary search trees. 
...
```console
jovyan@jupyter-yourcuid:~$ git clone git@github.com:cu-csci-2270-spring-2023/recitation-7-MyGitUsername.git
```
...
6. Within VS-Code, select `File -> Open` and then find the directory you just cloned. It should be `/home/jovyan/recitation-7-username`.

## Completing the recitation
Please refer `Recitation7.pdf` for more details.
...
2. Go to Canvas, locate the link titled **“Recitation 7”** and upload the zipped repository with your changes. Make sure you do submit your recitation prior to the deadline specified on Canvas.
