...
class BookCollection : public BookCollectionBase {
    ...
    public:
        ...
        void _hardDelete(Book* &T, string bookName);
        void _removeBookHelper(string bookName, Book* &T);
        Book* _searchBook(string bookName, Book* T);
        Book* _findMin(Book* T);
        Book* _findParent(string bookName, Book* T);
        int _findPath(string BookName, Book* T, string path[]);
